  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-8 py-12">
      <div className="text-center mb-10">
        <h1 className="font-display text-3xl md:text-4xl text-dark mb-3">{"Yêu Thích"}</h1>
        <p className="text-muted font-sans text-sm max-w-xl mx-auto">{"subtitle"}</p>
          ...
          <nav className="space-y-1">
            {sections.map(s => (
              <button key={s.id} onClick={() => setActive(s.id)}
                className={`w-full text-left px-4 py-3 text-sm font-sans transition-colors border-l-2 ${
                  active === s.id
