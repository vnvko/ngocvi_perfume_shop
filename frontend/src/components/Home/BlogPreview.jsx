  ...
  return (
    <section className="py-16 max-w-screen-xl mx-auto px-4 md:px-8">
      <div className="flex items-end justify-between mb-10">
        <div>
          <h2 className="section-title text-left">Perfume Journal</h2>
          ...
          <Link key={post.id} to={`/blog/${post.slug}`} className="group">
            <div className="overflow-hidden aspect-[4/3] mb-4">
              {post.thumbnail ? (
                ...
                <div className="w-full h-full bg-light-secondary flex items-center justify-center text-muted text-xs font-sans">Blog</div>
              )}
            </div>
            <div>
